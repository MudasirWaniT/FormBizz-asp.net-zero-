...
$webMvcFolder = Join-Path $slnFolder "src/Syntaq.Falcon.Web.Mvc"
$webPublicFolder = Join-Path $slnFolder "src/Syntaq.Falcon.Web.Public"
...
dotnet restore Syntaq.Falcon.Web.sln
