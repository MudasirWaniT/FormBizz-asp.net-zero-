...
using FormBizz.Authorization.Users.Password;
using FormBizz.Configuration;
using FormBizz.EntityFrameworkCore;
using FormBizz.MultiTenancy;
using FormBizz.Web.Startup.ExternalLoginInfoProviders;

namespace FormBizz.Web.Startup
{
    [DependsOn(
        typeof(FormBizzWebCoreModule)
    )]
    public class FormBizzWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public FormBizzWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FormBizzWebHostModule).GetAssembly());
        }
