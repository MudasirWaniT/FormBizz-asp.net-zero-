...
using FormBizz.Auditing.Exporting;
using FormBizz.Authorization;
using FormBizz.Authorization.Users;
using FormBizz.Dto;
using FormBizz.EntityHistory;
using EntityHistoryHelper = FormBizz.EntityHistory.EntityHistoryHelper;

namespace FormBizz.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : FormBizzAppServiceBase, IAuditLogAppService
    {
