...
namespace FormBizz.Web.Startup
{
    ...
    public class FormBizzWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FormBizzWebMvcModule(IWebHostEnvironment env)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Navigation.Providers.Add<FormBizzNavigationProvider>();
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FormBizzWebMvcModule).GetAssembly());
        }
