...
using FormBizz.Web.Models.TenantRegistration;

namespace FormBizz.Web.Controllers
{
    public class TenantRegistrationController : FormBizzControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "FormBizz" }));
                    }
