...
using FormBizz.Authentication.TwoFactor.Google;
using FormBizz.Authorization;
using FormBizz.Authorization.Accounts;
using FormBizz.Authorization.Accounts.Dto;
using FormBizz.Authorization.Delegation;
using FormBizz.Authorization.Impersonation;
...
using FormBizz.Net.Sms;
using FormBizz.Notifications;
using FormBizz.Web.Models.Account;
using FormBizz.Security;
using FormBizz.Security.Recaptcha;
using FormBizz.Sessions;
using FormBizz.Url;
using FormBizz.Web.Authentication.External;
using FormBizz.Web.Security.Recaptcha;
using FormBizz.Web.Session;
using FormBizz.Web.Views.Shared.Components.TenantChange;
using Abp.CachedUniqueKeys;
using Abp.AspNetCore.Mvc.Caching;

namespace FormBizz.Web.Controllers
{
    public class AccountController : FormBizzControllerBase
    {
        ...
        {
            return RedirectToAction("Index", "Home", new { area = "FormBizz" });
        }

        public string GetAppHomeUrl()
        {
            return Url.Action("Index", "Home", new { area = "FormBizz" });
        }
