...
namespace FormBizz.Web.Areas.FormBizz.Startup
{
    public class DashboardViewConfiguration
    {
        ...
        {
            var jsAndCssFileRoot = "/Areas/FormBizz/Views/CustomizableDashboard/Widgets/";
            var viewFileRoot = "FormBizz/Widgets/";

            #region FilterViewDefinitions

            WidgetFilterViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                new WidgetFilterViewDefinition(
                    FormBizzDashboardCustomizationConsts.Filters.FilterDateRangePicker,
                    "~/Areas/FormBizz/Views/Shared/Components/CustomizableDashboard/Widgets/DateRangeFilter.cshtml",
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.DailySales,
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.GeneralStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.ProfitShare,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.MemberActivity,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.RegionalStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.SalesSummary,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Tenant.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Host.IncomeStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Host.TopStats,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Host.EditionStatistics,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Host.SubscriptionExpiringTenants,
                new WidgetViewDefinition(
            ...
            WidgetViewDefinitions.Add(FormBizzDashboardCustomizationConsts.Widgets.Host.RecentTenants,
                new WidgetViewDefinition(
