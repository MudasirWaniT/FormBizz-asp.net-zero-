...
using FormBizz.Web.Areas.FormBizz.Models.DynamicEntityPropertyValues;
...
namespace FormBizz.Web.Areas.FormBizz.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : FormBizzControllerBase
    {
        ...
        [HttpGet("/FormBizz/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]
