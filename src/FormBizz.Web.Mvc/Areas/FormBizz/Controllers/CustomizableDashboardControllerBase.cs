...
using FormBizz.Web.Areas.FormBizz.Models.CustomizableDashboard;
...
{
    public abstract class CustomizableDashboardControllerBase : FormBizzControllerBase
    {
        ...
        public async Task<PartialViewResult> AddWidgetModal(string dashboardName, string pageId)
        {
            var availableWidgets = await DashboardCustomizationAppService.GetAllAvailableWidgetDefinitionsForPage(
                ...
                {
                    Application = FormBizzDashboardCustomizationConsts.Applications.Mvc,
                    PageId = pageId,
            ...
            return PartialView(
                "~/Areas/FormBizz/Views/Shared/Components/CustomizableDashboard/_AddWidgetModal.cshtml",
                viewModel
            );
        }
        ...
        protected async Task<ActionResult> GetView(string dashboardName)
        {
            ...
            return View("~/Areas/FormBizz/Views/Shared/Components/CustomizableDashboard/Index.cshtml",
