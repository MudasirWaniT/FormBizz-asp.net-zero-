...
namespace FormBizz.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : FormBizzServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("FormBizz", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
