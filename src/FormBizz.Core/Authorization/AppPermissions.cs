namespace FormBizz.Authorization
{
    ...
    public static class AppPermissions
    {
        ...
        // Phone Book 
        public const string Pages_PhoneBook = "Pages.PhoneBook"; 
        public const string Pages_PhoneBook_Create = "Pages.PhoneBook.Create";
        public const string Pages_PhoneBook_Edit = "Pages.PhoneBook.Edit"; 
        public const string Pages_PhoneBook_Delete = "Pages.PhoneBook.Delete";
        ...
        // Adding permission with unique name for phone book 
        //public const string Pages_Tenant_PhoneBook = "Pages.Tenant.PhoneBook";
        //public const string Pages_Tenant_PhoneBook = "Pages.Administration.Host.PhoneBook";
