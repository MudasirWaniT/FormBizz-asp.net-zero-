...
namespace FormBizz.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            // Added phone book as parent 
            var phoneBook = pages.CreateChildPermission(AppPermissions.Pages_PhoneBook, L("PhoneBook"));
            // adding phone book's childs
            phoneBook.CreateChildPermission(AppPermissions.Pages_PhoneBook_Create, L("CreateNewPerson"));
            phoneBook.CreateChildPermission(AppPermissions.Pages_PhoneBook_Edit, L("EditingPerson"));
            phoneBook.CreateChildPermission(AppPermissions.Pages_PhoneBook_Delete, L("DeletingPerson"));
            ...
            // Permission for Phone book 
            //pages.CreateChildPermission(AppPermissions.pagesph, L("PhoneBook"), multiTenancySides: MultiTenancySides.Tenant);
            //administration.CreateChildPermission(AppPermissions.Pages_Administration_PhoneBook, L("PhoneBook"), multiTenancySides: MultiTenancySides.Tenant);
        }
