...
using FormBizz.Authorization.Ldap;
using FormBizz.Authorization.Roles;
using FormBizz.Authorization.Users;
using FormBizz.Chat;
using FormBizz.Configuration;
using FormBizz.DashboardCustomization.Definitions;
using FormBizz.Debugging;
using FormBizz.DynamicEntityProperties;
using FormBizz.Features;
using FormBizz.Friendships;
using FormBizz.Friendships.Cache;
using FormBizz.Localization;
using FormBizz.MultiTenancy;
using FormBizz.Net.Emailing;
using FormBizz.Notifications;
using FormBizz.WebHooks;
using Newtonsoft.Json;

namespace FormBizz
{
    [DependsOn(
        typeof(FormBizzCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class FormBizzCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            FormBizzLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = FormBizzConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, FormBizzMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<FormBizzSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FormBizzCoreModule).GetAssembly());
        }
