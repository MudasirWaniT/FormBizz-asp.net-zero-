...
namespace FormBizz.Web.Public.Startup
{
    ...
    public class FormBizzWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public FormBizzWebFrontEndModule(IWebHostEnvironment env, FormBizzEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(FormBizzWebFrontEndModule).GetAssembly());
        }
    }
}
