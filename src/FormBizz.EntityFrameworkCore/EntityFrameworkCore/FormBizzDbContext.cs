...
{
    public class FormBizzDbContext : AbpZeroDbContext<Tenant, Role, User, FormBizzDbContext>, IAbpPersistedGrantDbContext
    {
        ...
        public FormBizzDbContext(DbContextOptions<FormBizzDbContext> options)
            : base(options)
        {
