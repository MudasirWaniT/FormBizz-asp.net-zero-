...
{
    public class SubscriptionPaymentRepository : FormBizzRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<FormBizzDbContext> dbContextProvider)
