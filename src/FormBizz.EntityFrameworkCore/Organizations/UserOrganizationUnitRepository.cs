...
namespace FormBizz.Organizations
{
    public class UserOrganizationUnitRepository : FormBizzRepositoryBase<UserOrganizationUnit, long>,
        IUserOrganizationUnitRepository
    {
        public UserOrganizationUnitRepository(IDbContextProvider<FormBizzDbContext> dbContextProvider)
