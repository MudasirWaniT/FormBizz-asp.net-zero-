...
namespace FormBizz.Web.UiCustomization.Metronic
{
    public class ThemeDefaultUiCustomizer : UiThemeCustomizerBase, IUiCustomizer
    {
        ...
        public async Task<UiCustomizationSettingsDto> GetUiSettings()
        {
            ...
            settings.BaseSettings.SubHeader.TitleStyle = "page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0";
