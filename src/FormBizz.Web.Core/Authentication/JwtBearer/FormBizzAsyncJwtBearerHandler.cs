...
{
    public class FormBizzAsyncJwtBearerHandler : AuthenticationHandler<AsyncJwtBearerOptions>
    {
        ...
        /// </summary>
        /// <inheritdoc />
        public FormBizzAsyncJwtBearerHandler(IOptionsMonitor<AsyncJwtBearerOptions> options,
