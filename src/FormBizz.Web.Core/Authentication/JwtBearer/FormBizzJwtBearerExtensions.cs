...
/// </summary>
public static class FormBizzJwtBearerExtensions
{
    /// <summary>
    ...
    public static AuthenticationBuilder AddAbpAsyncJwtBearer(this AuthenticationBuilder builder, string authenticationScheme, string? displayName, Action<AsyncJwtBearerOptions> configureOptions)
    {
        ...
        return builder.AddScheme<AsyncJwtBearerOptions, FormBizzAsyncJwtBearerHandler>(authenticationScheme, displayName, configureOptions);
    }
}
