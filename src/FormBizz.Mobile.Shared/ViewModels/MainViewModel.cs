...
using Syntaq.Falcon.Services.Navigation;
...
using Syntaq.Falcon.ApiClient;
using Syntaq.Falcon.Controls;
using Syntaq.Falcon.Dto;
using Syntaq.Falcon.Extensions;
using Syntaq.Falcon.Localization;
using Syntaq.Falcon.UI;
using Syntaq.Falcon.UI.Assets;
using Syntaq.Falcon.Views;
using DependencyResolver = Syntaq.Falcon.Core.Dependency.DependencyResolver;
...
namespace Syntaq.Falcon.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Falcon";
